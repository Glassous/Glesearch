<template>
  <div class="random-girl-images-container">
    <!-- 顶部栏 -->
    <div class="header">
...
export default {
  ...
  data() {
    return {
      ...
      modes: [
        ...
        { key: 'meinv', name: '美女图片', apis: ['https://v2.xxapi.cn/api/meinvpic'] },
        { key: 'baisi', name: '白丝图片', apis: ['https://v2.xxapi.cn/api/baisi'] },
        { key: 'heisi', name: '黑丝图片', apis: ['https://v2.xxapi.cn/api/heisi'] },
        { key: 'jk', name: 'JK图片', apis: ['https://v2.xxapi.cn/api/jk'] }
      ]
    }
  },
  mounted() {
  ...
  methods: {
    ...
    async openFullscreen() {
      if (!this.currentImage || !this.$refs.girlImage) return
      
      try {
        const imageElement = this.$refs.girlImage
    ...
    async downloadImage() {
      ...
      try {
        ...
        link.href = url
        link.download = `girl-image-${Date.now()}.jpg`
