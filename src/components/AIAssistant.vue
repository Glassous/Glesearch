...
.chatgpt-svg, .deepseek-svg, .grok-svg, .claude-svg, .gemini-svg, .qwen-png {
  display: flex;
  align-items: center;
  justify-content: center;
}

.chatgpt-svg svg, .deepseek-svg svg, .grok-svg svg, .claude-svg svg, .gemini-svg img, .qwen-png img {
  transition: all 0.3s ease;
}

.ai-card:hover .chatgpt-svg svg, .ai-card:hover .deepseek-svg svg, .ai-card:hover .grok-svg svg, .ai-card:hover .claude-svg svg, .ai-card:hover .gemini-svg img, .ai-card:hover .qwen-png img {
  transform: scale(1.1);
}
